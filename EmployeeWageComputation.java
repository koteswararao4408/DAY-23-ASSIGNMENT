public class EmployeeWageComputation							//Main class
{
        ...
        public CompanyWage[] companyWageArray;						//Array for wages of a different companies

        public EmployeeWageComputation()						//Default constructor
        {
                companyWageArray=new CompanyWage[4];
        }

        public void addCompanyWage(String company,int empRatePerHr,int numOfWorkingDays,int maxWorkingHrs)	//Add method for adding companies
        {
